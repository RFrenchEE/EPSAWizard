...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comptree.header().setProperty("showSortIndicator", False)
        ...
        self.menubar.setGeometry(QRect(0, 0, 721, 17))
...
#if QT_CONFIG(tooltip)
        self.btn_prevcomp.setToolTip(QCoreApplication.translate("MainWindow", u"Previous component of this type", None))
#endif // QT_CONFIG(tooltip)
        self.btn_prevcomp.setText(QCoreApplication.translate("MainWindow", u"  Prev", None))
#if QT_CONFIG(tooltip)
        self.btn_nextcomp.setToolTip(QCoreApplication.translate("MainWindow", u"Next component of this type", None))
#endif // QT_CONFIG(tooltip)
        self.btn_nextcomp.setText(QCoreApplication.translate("MainWindow", u"Next  ", None))
#if QT_CONFIG(tooltip)
        self.btn_compdefault.setToolTip(QCoreApplication.translate("MainWindow", u"Set this component's values to default", None))
#endif // QT_CONFIG(tooltip)
