...
class Ui_ResistorWidget(object):
    def setupUi(self, ResistorWidget):
        ...
        self.groupBox_pn = QGroupBox(ResistorWidget)
        self.groupBox_pn.setObjectName(u"groupBox_pn")
        sizePolicy.setHeightForWidth(self.groupBox_pn.sizePolicy().hasHeightForWidth())
        self.groupBox_pn.setSizePolicy(sizePolicy)
        self.groupBox_pn.setMinimumSize(QSize(0, 45))
        self.groupBox_pn.setMaximumSize(QSize(16777215, 55))
        font = QFont()
        font.setFamilies([u"Liberation Sans"])
        font.setPointSize(8)
        self.groupBox_pn.setFont(font)
        self.groupBox_pn.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        self.groupBox_pn.setFlat(False)
        self.horizontalLayout_2 = QHBoxLayout(self.groupBox_pn)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(2, 2, 2, 2)
        self.lbl_mpn = QLabel(self.groupBox_pn)
        self.lbl_mpn.setObjectName(u"lbl_mpn")
        self.lbl_mpn.setMinimumSize(QSize(30, 20))
        self.lbl_mpn.setMaximumSize(QSize(80, 30))
        font1 = QFont()
        font1.setFamilies([u"Liberation Sans"])
        font1.setPointSize(10)
        self.lbl_mpn.setFont(font1)

        self.horizontalLayout_2.addWidget(self.lbl_mpn)

        self.input_mpn = QLineEdit(self.groupBox_pn)
        ...
        self.input_mpn.setMinimumSize(QSize(120, 20))
        self.input_mpn.setMaximumSize(QSize(200, 30))
        self.input_mpn.setFont(font)

        self.horizontalLayout_2.addWidget(self.input_mpn)

        self.hspacer_pn_middle = QSpacerItem(5, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_2.addItem(self.hspacer_pn_middle)

        self.lbl_apn = QLabel(self.groupBox_pn)
        self.lbl_apn.setObjectName(u"lbl_apn")
        self.lbl_apn.setMinimumSize(QSize(30, 20))
        self.lbl_apn.setMaximumSize(QSize(80, 30))
        self.lbl_apn.setFont(font1)
        self.lbl_apn.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout_2.addWidget(self.lbl_apn)

        self.input_apn = QLineEdit(self.groupBox_pn)
        ...
        self.input_apn.setMinimumSize(QSize(120, 20))
        self.input_apn.setMaximumSize(QSize(200, 30))
        self.input_apn.setFont(font)

        self.horizontalLayout_2.addWidget(self.input_apn)

        self.hspacer_pn_middle2 = QSpacerItem(5, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_2.addItem(self.hspacer_pn_middle2)

        self.lbl_type = QLabel(self.groupBox_pn)
        self.lbl_type.setObjectName(u"lbl_type")
        self.lbl_type.setMinimumSize(QSize(30, 0))
        self.lbl_type.setMaximumSize(QSize(80, 16777215))
        self.lbl_type.setFont(font1)

        self.horizontalLayout_2.addWidget(self.lbl_type)

        self.combo_type = QComboBox(self.groupBox_pn)
        ...
        self.combo_type.setMinimumSize(QSize(100, 20))
        self.combo_type.setMaximumSize(QSize(120, 30))
        ...
        self.verticalLayout.addWidget(self.groupBox_pn)
        ...
        self.val_gridgroupBox.setMinimumSize(QSize(0, 120))
        self.val_gridgroupBox.setMaximumSize(QSize(16777215, 200))
        self.val_gridgroupBox.setFont(font)
        self.val_gridgroupBox.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        ...
        self.unitlbl_Trated.setMinimumSize(QSize(40, 20))
        ...
        self.unitlbl_Vmaxapplied.setMinimumSize(QSize(40, 20))
        ...
        sizePolicy.setHeightForWidth(self.input_Tbase.sizePolicy().hasHeightForWidth())
        self.input_Tbase.setSizePolicy(sizePolicy)
        self.input_Tbase.setMinimumSize(QSize(50, 20))
        self.input_Tbase.setMaximumSize(QSize(100, 30))
        self.input_Tbase.setFont(font)
        ...
        sizePolicy.setHeightForWidth(self.input_T0.sizePolicy().hasHeightForWidth())
        self.input_T0.setSizePolicy(sizePolicy)
        self.input_T0.setMinimumSize(QSize(50, 20))
        self.input_T0.setMaximumSize(QSize(100, 30))
        self.input_T0.setFont(font)
        ...
        self.unitlbl_R.setMinimumSize(QSize(40, 20))
        ...
        self.lbl_Vmaxapplied.setMinimumSize(QSize(100, 20))
        self.lbl_Vmaxapplied.setMaximumSize(QSize(100, 30))
        ...
        self.lbl_Prated.setMinimumSize(QSize(100, 20))
        self.lbl_Prated.setMaximumSize(QSize(100, 30))
        ...
        sizePolicy.setHeightForWidth(self.input_Vrated.sizePolicy().hasHeightForWidth())
        self.input_Vrated.setSizePolicy(sizePolicy)
        self.input_Vrated.setMinimumSize(QSize(50, 20))
        self.input_Vrated.setMaximumSize(QSize(100, 30))
        self.input_Vrated.setFont(font)
        ...
        self.lbl_Trated.setMinimumSize(QSize(100, 20))
        self.lbl_Trated.setMaximumSize(QSize(100, 30))
        ...
        sizePolicy.setHeightForWidth(self.input_Vmaxapplied.sizePolicy().hasHeightForWidth())
        self.input_Vmaxapplied.setSizePolicy(sizePolicy)
        self.input_Vmaxapplied.setMinimumSize(QSize(50, 20))
        self.input_Vmaxapplied.setMaximumSize(QSize(100, 30))
        ...
        self.unitlbl_Tbase.setMinimumSize(QSize(40, 20))
        ...
        self.lbl_ThetaR.setMinimumSize(QSize(100, 20))
        self.lbl_ThetaR.setMaximumSize(QSize(100, 30))
        ...
        sizePolicy.setHeightForWidth(self.input_Prated.sizePolicy().hasHeightForWidth())
        self.input_Prated.setSizePolicy(sizePolicy)
        self.input_Prated.setMinimumSize(QSize(50, 20))
        self.input_Prated.setMaximumSize(QSize(100, 30))
        self.input_Prated.setFont(font)
        ...
        sizePolicy.setHeightForWidth(self.input_ThetaR.sizePolicy().hasHeightForWidth())
        self.input_ThetaR.setSizePolicy(sizePolicy)
        self.input_ThetaR.setMinimumSize(QSize(50, 20))
        self.input_ThetaR.setMaximumSize(QSize(100, 30))
        ...
        self.lbl_Vrated.setMinimumSize(QSize(100, 20))
        self.lbl_Vrated.setMaximumSize(QSize(100, 30))
        ...
        self.unitlbl_T0.setMinimumSize(QSize(40, 20))
        ...
        self.hspacer_row4_middle = QSpacerItem(5, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)
        ...
        sizePolicy.setHeightForWidth(self.input_R.sizePolicy().hasHeightForWidth())
        self.input_R.setSizePolicy(sizePolicy)
        self.input_R.setMinimumSize(QSize(50, 20))
        self.input_R.setMaximumSize(QSize(100, 30))
        self.input_R.setFont(font)
        ...
        self.hspacer_row3_middle = QSpacerItem(5, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)
        ...
        self.lbl_T0.setMinimumSize(QSize(100, 20))
        self.lbl_T0.setMaximumSize(QSize(100, 30))
        ...
        sizePolicy.setHeightForWidth(self.input_Trated.sizePolicy().hasHeightForWidth())
        self.input_Trated.setSizePolicy(sizePolicy)
        self.input_Trated.setMinimumSize(QSize(50, 20))
        self.input_Trated.setMaximumSize(QSize(100, 30))
        ...
        self.unitlbl_ThetaR.setMinimumSize(QSize(40, 20))
        ...
        self.unitlbl_Vrated.setMinimumSize(QSize(40, 20))
        ...
        self.hspacer_row2_middle = QSpacerItem(5, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)
        ...
        self.unitlbl_Prated.setMinimumSize(QSize(40, 20))
        ...
        self.lbl_R.setMinimumSize(QSize(100, 20))
        self.lbl_R.setMaximumSize(QSize(100, 30))
        ...
        self.lbl_Tbase.setMinimumSize(QSize(100, 20))
        self.lbl_Tbase.setMaximumSize(QSize(100, 30))
        ...
        self.hspacer_row1_middle = QSpacerItem(5, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)
        ...
        self.groupBox_notes.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        self.groupBox_notes.setFlat(False)
        self.horizontalLayout_3 = QHBoxLayout(self.groupBox_notes)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(2, 2, 2, 2)
        self.lbl_notes = QLabel(self.groupBox_notes)
        self.lbl_notes.setObjectName(u"lbl_notes")
        self.lbl_notes.setMinimumSize(QSize(100, 60))
        self.lbl_notes.setMaximumSize(QSize(200, 16777215))
        self.lbl_notes.setFont(font1)
        self.lbl_notes.setTextFormat(Qt.RichText)
        self.lbl_notes.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.textedit_notes.setMinimumSize(QSize(380, 60))
        self.textedit_notes.setMaximumSize(QSize(500, 16777215))
        self.textedit_notes.setFont(font1)
        self.textedit_notes.setTabChangesFocus(True)

        self.horizontalLayout_3.addWidget(self.textedit_notes)

        self.hspacer_notes_right = QSpacerItem(5, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_3.addItem(self.hspacer_notes_right)


        self.verticalLayout.addWidget(self.groupBox_notes)

        QWidget.setTabOrder(self.input_mpn, self.input_apn)
        QWidget.setTabOrder(self.input_apn, self.combo_type)
        QWidget.setTabOrder(self.combo_type, self.input_R)
    ...
    def retranslateUi(self, ResistorWidget):
        ...
        self.groupBox_pn.setTitle(QCoreApplication.translate("ResistorWidget", u"PN and Type", None))
...
#endif // QT_CONFIG(tooltip)
        self.lbl_type.setText(QCoreApplication.translate("ResistorWidget", u"Type: ", None))
        self.combo_type.setItemText(0, QCoreApplication.translate("ResistorWidget", u"G311P672", None))
        self.combo_type.setItemText(1, QCoreApplication.translate("ResistorWidget", u"G311P683", None))
        self.combo_type.setItemText(2, QCoreApplication.translate("ResistorWidget", u"G311P742", None))
        self.combo_type.setItemText(3, QCoreApplication.translate("ResistorWidget", u"RBR, 1%", None))
        self.combo_type.setItemText(4, QCoreApplication.translate("ResistorWidget", u"RBR, 0.5%", None))
        self.combo_type.setItemText(5, QCoreApplication.translate("ResistorWidget", u"RBR, 0.1%", None))
        self.combo_type.setItemText(6, QCoreApplication.translate("ResistorWidget", u"RWR", None))
        self.combo_type.setItemText(7, QCoreApplication.translate("ResistorWidget", u"RCR", None))
        self.combo_type.setItemText(8, QCoreApplication.translate("ResistorWidget", u"RER", None))
        self.combo_type.setItemText(9, QCoreApplication.translate("ResistorWidget", u"RTR", None))
        self.combo_type.setItemText(10, QCoreApplication.translate("ResistorWidget", u"RLR, 100ppm", None))
        self.combo_type.setItemText(11, QCoreApplication.translate("ResistorWidget", u"RLR, 350ppm", None))
        self.combo_type.setItemText(12, QCoreApplication.translate("ResistorWidget", u"RNX", None))
        self.combo_type.setItemText(13, QCoreApplication.translate("ResistorWidget", u"RM", None))
        self.combo_type.setItemText(14, QCoreApplication.translate("ResistorWidget", u"RZ", None))
        self.combo_type.setItemText(15, QCoreApplication.translate("ResistorWidget", u"Other", None))
        ...
        self.lbl_Vmaxapplied.setText(QCoreApplication.translate("ResistorWidget", u"Max DV Applied: ", None))
        self.lbl_Prated.setText(QCoreApplication.translate("ResistorWidget", u"Power Rating: ", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.lbl_Trated.setText(QCoreApplication.translate("ResistorWidget", u"Rated T: ", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.lbl_Vrated.setText(QCoreApplication.translate("ResistorWidget", u"Max Rated V: ", None))
...
#endif // QT_CONFIG(tooltip)
        self.lbl_T0.setText(QCoreApplication.translate("ResistorWidget", u"Zero-Power T: ", None))
#if QT_CONFIG(tooltip)
        ...
        self.lbl_R.setText(QCoreApplication.translate("ResistorWidget", u"Resistance: ", None))
        self.lbl_Tbase.setText(QCoreApplication.translate("ResistorWidget", u"Baseplate T: ", None))
        self.groupBox_notes.setTitle(QCoreApplication.translate("ResistorWidget", u"User Notes", None))
        self.lbl_notes.setText(QCoreApplication.translate("ResistorWidget", u"<html><head/><body><p>One note per line:</p></body></html>", None))
#if QT_CONFIG(tooltip)
